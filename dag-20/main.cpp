...
bool compare(int a, int b) {
  ostringstream stringify_a;
  ostringstream stringify_b;

  stringify_a << a;
  stringify_b << b;

  string a_first = stringify_a.str() + stringify_b.str();
  string b_first = stringify_b.str() + stringify_a.str();

  int first = stoi(a_first);
  int second = stoi(b_first);
